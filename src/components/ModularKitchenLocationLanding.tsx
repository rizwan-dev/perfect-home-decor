...
const heroImage = "/images/stock/modular-kitchen-design-pune.webp";
...
export function ModularKitchenLocationLanding({ area }: { area: AreaSlug }) {
  ...
  return (
    <>
      <JsonLd
        data={serviceJsonLd({
          name: `Modular kitchen in ${c.areaLabel}`,
      ...
      <JsonLd
        data={breadcrumbJsonLd([
          { name: "Home", path: "/" },
          { name: `Modular kitchen in ${c.areaLabel}`, path },
        ])}
      />
      ...
      <section className="relative overflow-hidden border-b border-stone-200 bg-stone-900">
        <div className="absolute inset-0">
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-charcoal/[0.97] via-charcoal/88 to-wood-dark/80" />
          <div
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_30%_0%,rgba(247,244,239,0.1),transparent_55%)]"
            aria-hidden
          />
        </div>
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            >
              Free kitchen consult in {c.areaLabel}
            </Link>
            <a
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="rounded-3xl border border-stone-200/90 bg-white p-8 shadow-sm sm:p-10">
              <h2 className="font-display text-2xl text-charcoal sm:text-3xl">
                Kitchens in context — {c.areaLabel}
              </h2>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Process"
          title={`How we deliver modular kitchens in ${c.areaLabel}`}
          description="Measurements you can trust, drawings you sign, factory dates you can plan around."
        />
      ...
      <section className="border-t border-stone-200 bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            title="Kitchens built for Indian cooking—and your floor plate"
          />
      ...
      <section className="border-t border-stone-200 bg-stone-50 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            eyebrow="FAQs"
            title={`Modular kitchen questions in ${c.areaLabel}`}
          />
      ...
      <section className="border-t border-stone-200 bg-cream py-16 sm:py-20">
        <div className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            <SectionHeading
              eyebrow="Start here"
              title={`Book a kitchen visit in ${c.areaLabel}`}
            />
            <p className="mt-4 text-sm leading-relaxed text-stone-600 sm:text-base">
              Bring your floor plan, photos, and appliance thoughts—we return with
              layout options, a BOQ structure, and realistic factory timelines.
            </p>
            ...
            <ul className="mt-3 flex flex-wrap gap-2">
              {AREAS.filter((x) => x.slug !== area).map((x) => (
                <li key={x.slug}>
                  <Link
                    href={`/modular-kitchen-in-${x.slug}`}
      ...
      <CTASection
        ...
        subtitle="Layouts, factory drawings, install, and stone—aligned to how you cook and how your society runs."
      />
    </>
  );
}
